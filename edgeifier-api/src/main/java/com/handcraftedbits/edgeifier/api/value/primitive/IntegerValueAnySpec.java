...
/**
 * Used to specify constraints for integer value generation.
 */

public interface IntegerValueAnySpec extends ValueBuilder<Integer> {
     /**
      * Specifies that the generated value must be greater than or equal to the given value.
      *
      * @param minimum a integer containing the minimum value (inclusive).
      * @return a {@link ValueBuilder} object used to generate values.
      */

     ValueBuilder<Integer> atLeast (int minimum);
      ...
      *
      * @param minimum a integer containing the minimum value (inclusive).
      * @param maximum a integer containing the maximum value (exclusive).
      * @return a {@link ValueBuilder} object used to generate values.
      * @throws IllegalArgumentException if the maximum value is less than or equal to the minimum value.
      */

     ValueBuilder<Integer> between (int minimum, int maximum);
     ...
     ValueBuilder<Integer> lessThan (int maximum);
}
