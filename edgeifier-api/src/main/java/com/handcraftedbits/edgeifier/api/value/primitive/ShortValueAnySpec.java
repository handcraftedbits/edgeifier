...
/**
 * Used to specify constraints for short value generation.
 */

public interface ShortValueAnySpec extends ValueBuilder<Short> {
     /**
      * Specifies that the generated value must be greater than or equal to the given value.
      *
      * @param minimum a short containing the minimum value (inclusive).
      * @return a {@link ValueBuilder} object used to generate values.
      */

     ValueBuilder<Short> atLeast (short minimum);
      ...
      *
      * @param minimum a short containing the minimum value (inclusive).
      * @param maximum a short containing the maximum value (exclusive).
      * @return a {@link ValueBuilder} object used to generate values.
      * @throws IllegalArgumentException if the maximum value is less than or equal to the minimum value.
      */

     ValueBuilder<Short> between (short minimum, short maximum);
     ...
     ValueBuilder<Short> lessThan (short maximum);
}
