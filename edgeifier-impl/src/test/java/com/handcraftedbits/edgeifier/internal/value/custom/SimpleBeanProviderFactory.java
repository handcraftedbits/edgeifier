...
public class SimpleBeanProviderFactory implements CustomValueProviderFactory<SimpleBean> {
     @Override
     public CustomValueProvider<SimpleBean> newCustomValueProvider () {
          return new SimpleBeanProvider();
     }

     @Override
     public Class<SimpleBean> valueClass () {
